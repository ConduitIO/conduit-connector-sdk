module github.com/conduitio/conduit-connector-sdk/conn-sdk-cli

go 1.24

// TODO remove replace when we have a release
...
require (
	...
	github.com/conduitio/conduit-connector-sdk v0.0.0-00010101000000-000000000000
